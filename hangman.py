...
wordswithoutspliting = '''"ant baboon badger bat bear beaver camel cat clam cobra cougar
...
zebra"'''
words = wordswithoutspliting.split()
    ...
    if guess in secretWord:
        ...
        for i in range(len(secretWord)):
            if secretWord[i] not in correctLetters:
                ...
                break
        if foundAllLetters:
            print("Yes! The secret word is " + str(secretWord) + " ! You have won!")
            gameIsDone = True
